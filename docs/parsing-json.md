...
Состав полей в порту формируется динамически (используется автосинхронизация полей) и зависит от структуры JSON. Набор данных содержит обязательное поле **Индекс входной строки**.

### Переменные в порте "Ошибки"

| № | Метка                   | Тип                               | Значение                                                                           |
|:--|:------------------------|:----------------------------------|:-----------------------------------------------------------------------------------|
| 1 | Индекс входной строки   | ![](./img/integer.svg) Целый      |                                                                                    |
| 2 | Строка JSON             | ![](./img/string.svg) Строковый   | Набор данных в формате JSON                                                        | 
| 3 | Исключение              | ![](./img/string.svg) Строковый   | В переменную выводится текст перехваченной ошибки в ходе трансформации данных      |